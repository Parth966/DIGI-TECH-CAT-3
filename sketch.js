...
function cone_obstacle(){
  obs1 = createSprite(1200,200,50,50)
...
function manhole_obstacle(){
  obs2 = createSprite(1200,100,50,50)
...
function nails_obstacle(){
  obs3 = createSprite(1200,150,50,50)
...
function redCyclists() {
  ...
  player3.addAnimation("images/opponentPlayer3", oppRed1Img);
